...
const LoadWallet = ({ navigation, route }: ScreenProps) => {
      ...
      <View style={{ flex: 1, padding: 10 }}>
        <View style={[styles.frow]}>
          ...
          <Text style={{ flex: 1 }} variant="bodySmall">
            Please note that loading your wallet through card as an agent attracts
            a card processing fee of 1.5%. To avoid paying this charge, please
            load your wallet through bank deposit
          </Text>
        </View>
        <TextInput
          label="Amount"
